...
public enum QuartzServer {
	 ...
	 * @user <a href=mailto:zhucg@bonree.com>朱成岗</a>
	 */
	public boolean loadJob(JobDetail jobDetail, Trigger trigger) throws SchedulerException{
		if(scheduler == null){
	 ...
	 * @user <a href=mailto:zhucg@bonree.com>朱成岗</a>
	 */
	public boolean loadJob(JobConfig jobConfig) throws NullPointerException, ParseException, SchedulerException{
		return loadJob((Class<? extends Job>) jobConfig.getJobClass(), jobConfig.getCronTime(), jobConfig.getJobName(), jobConfig.getJobGroup());
	}
	/**
	 * 概述：启动服务
	 * @return
