...
public class CopyCheckJob extends QuartzOperationStateTask {
    ...
    public void operation(JobExecutionContext context) throws Exception {
        ...
        List<Service> services =
            sm.getServiceListByGroup(Configs.getConfiguration().getConfig(CommonConfigs.CONFIG_DATA_SERVICE_GROUP_NAME));
        ...
        Pair<TaskModel, Map<String, Long>> pair =
            CreateSystemTask.creatTaskWithFiles(sourceTimes, losers, needSns, TaskType.SYSTEM_COPY_CHECK, RECOVERY_NUM, 0);
        if (pair == null) {
