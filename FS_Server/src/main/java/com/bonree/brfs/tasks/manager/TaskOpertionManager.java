...
public class TaskOpertionManager implements LifeCycle {
            ...
            public void run() {
                try {
                    ...
                    SumbitTaskInterface task = QuartzSimpleInfo
                        .createCycleTaskInfo(TASK_OPERATION_MANAGER, executeInterval, 60000, null,
     ...
     */
    private static Map<String, String> recoveryTask(Collection<TaskType> swtichList, MetaTaskManagerInterface release,
                                                    String serverId) {
