...
public class MultiRecover3 implements DataRecover {
    ...
    public MultiRecover3(BalanceTaskSummary summary, ServerIDManager idManager, ServiceManager serviceManager, String taskNode,
                         CuratorClient client, String dataDir, String storageName, String baseRoutesPath) {
    ...
    private void dealFiles(List<String> fileNames, String timeFileName, int replica, String snDataDir) {
        for (String fileName : fileNames) {
            ...
            String filePath = snDataDir + FileUtils.FILE_SEPARATOR + replica + FileUtils.FILE_SEPARATOR + timeFileName
                + FileUtils.FILE_SEPARATOR + fileName;
                    ...
                    if (isAlive(getAliveMultiIds(), selectMultiId)) {
                        ...
                        if (!idManager.getSecondServerID(balanceSummary.getStorageIndex()).equals(selectMultiId)) {
                            ...
                            FileRecoverMeta fileMeta =
                                new FileRecoverMeta(perFile, fileName, selectMultiId, timeFileName, replica, pot + 1, firstID);
                            try {
                            ...
                            if (fileRecover != null) {
                                ...
                                Service service = serviceManager.getServiceById(
                                    Configs.getConfiguration()
                                           .getConfig(CommonConfigs.CONFIG_DATA_SERVICE_GROUP_NAME),
                                    fileRecover
                                        .getFirstServerID());
