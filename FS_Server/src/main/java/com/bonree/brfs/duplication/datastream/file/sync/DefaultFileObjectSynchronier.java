...
public class DefaultFileObjectSynchronier implements FileObjectSynchronizer, LifeCycle {
    ...
    private ScheduledExecutorService scheduler =
        Executors.newSingleThreadScheduledExecutor(new PooledThreadFactory("file_sync_sched"));
    ...
    public DefaultFileObjectSynchronier(FileObjectSyncProcessor processor, ServiceManager serviceManager, long checkPeriod,
                                        TimeUnit unit) {
