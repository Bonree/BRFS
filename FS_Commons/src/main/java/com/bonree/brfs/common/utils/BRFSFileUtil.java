...
public class BRFSFileUtil {
     ...
     * @return
     */
    public static List<BRFSPath> scanDurationDirs(String root, Map<String, String> map, final Map<String, String> startTime,
                                                  final Map<String, String> endTime, final List<String> pathlevel, int index) {
