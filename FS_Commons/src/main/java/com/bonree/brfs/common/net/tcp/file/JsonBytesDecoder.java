 ...
 */
public class JsonBytesDecoder extends ByteToMessageDecoder {
    ...
    public JsonBytesDecoder() {
        // 1 MB
        this(1024 * 1024);
    }

    public JsonBytesDecoder(int maxObjectLength) {
        this(maxObjectLength, false);
    }

    public JsonBytesDecoder(boolean streamArrayElements) {
