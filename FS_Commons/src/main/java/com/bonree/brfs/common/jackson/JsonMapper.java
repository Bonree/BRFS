...
public class JsonMapper implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    ...
    public Object readFrom(Class<Object> type, Type genericType, Annotation[] annotations, MediaType mediaType,
        ...
        try {
            ...
            // We want to handle parsing exceptions differently than regular IOExceptions so
            // just rethrow IOExceptions
            ...
            // Note: we are not logging at a higher level because this could cause a denial
            // of service
            log.debug(String.format(Locale.ENGLISH, "Invalid json for Java type %s", type), e);

            // Invalid json request. Throwing exception so the response code can be
    ...
    public void writeTo(Object value, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
        ...
        if (genericType != null && value != null) {
            ...
            if (genericType.getClass() != Class.class) { // generic types are other implementations of
                ...
                // 26-Feb-2011, tatu: To help with [JACKSON-518], we better recognize cases
                // where
                // type degenerates back into "Object.class" (as is the case with plain
                // TypeVariable,
