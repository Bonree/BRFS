...
public final class SystemProperties {
	public static final String PROP_BRFS_HOME = "brfs.home";
	public static final String PROP_SERVER_ID_DIR = "server.ids";
	/**
	 * 磁盘分区id文件的路径
	 */
	public static final String PROP_PARTITION_ID_IDR="partition.ids";
