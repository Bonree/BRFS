...
public class BRFSException extends Exception {
    private static final long serialVersionUID = 1L;

    public BRFSException(String message) {
        super(message);
    }
    ...
    public BRFSException(Throwable cause, String message) {
        super(message, cause);
    }

    public BRFSException(Throwable cause, String format, Object... arguments) {
